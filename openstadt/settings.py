...
class Config:
    ...
    SECURITY_TOTP_ISSUER = "OpenStadt"
    ...
    SECURITY_EMAIL_SENDER = os.environ.get("SECURITY_EMAIL_SENDER", "info@openstadt.de")
    ...
    # OpenStadt specific
    CITIES_CONFIG_PATH = os.environ.get(
        "CITIES_CONFIG_PATH",
        os.path.join(PROJECT_ROOT, "config", "cities"),
    )
    DEFAULT_CITY = os.environ.get("DEFAULT_CITY", "mannheim")
